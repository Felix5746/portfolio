...
import {Alert, Collapse, Grid, List} from '@mui/material'
        ...
        <Container maxWidth={'md'}>
            ...
            <Grid container spacing={2}>
                <ContactElement width={7}>
                    ...
                    <h2>Contact me</h2>
                    <Textbox label={'First name'} placeholder={'Enter your first name'} name={'firstname'} value={firstName} changeHandler={setFirstName}/>
                    <Textbox label={'Last name'} placeholder={'Enter your last name'} name={'lastname'} value={lastName} changeHandler={setLastName}/>
                    <Textbox label={'Email'} placeholder={'Enter your Email'} name={'email'} value={email} changeHandler={setEmail}/>
                    <MultilineTextbox label={'Message'} placeholder={'Enter your message here'} name={'message'}value={message} changeHandler={setMessage}/>
                    <Button sx={{marginY: 2}} fullWidth variant="contained"  type={'submit'}>Send</Button>
                    </form>
                </ContactElement>
